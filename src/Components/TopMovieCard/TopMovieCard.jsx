...
export default function TopMovieCard({id , type , src , title , rating , index}) {
    return (
        <a href={`/${type == 'series' ? 'series' : 'movie'}/${id}`} className="flex flex-col gap-2 items-center transition-all hover:-translate-y-2 group">
