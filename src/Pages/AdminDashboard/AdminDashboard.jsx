...
let userActivity = [
    { title: "درخواست ها", value: "125", children: <TbTicket className="text-white text-xl xl:text-2xl" />, color: 'from-orange-400 to-orange-600' },
    { title: "مطالب درخواستی", value: "256", children: <IoIosAddCircleOutline className="text-white text-xl xl:text-2xl" />, color: 'from-purple-600 to-purple-800' },
    { title: "عضویت", value: "20/12/2024", children: <PiUserFocusFill className="text-white text-xl xl:text-2xl" />, color: 'from-sky-400 to-sky-700' },
    { title: "كاربر ها", value: "12000", children: <FaUsers className="text-white text-xl xl:text-2xl" />, color: 'from-green-400 to-green-600' }
]
